...
import './profile-bar-unhover11.css'

const ProfileBarUnhover11 = (props) => {
  return (
    <div className="profile-bar-unhover11-container">
      <div className="profile-bar-unhover11-container1">
        <div className="profile-bar-unhover11-container2">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon">
            <path d="M576 706.612v-52.78c70.498-39.728 128-138.772 128-237.832 0-159.058 0-288-192-288s-192 128.942-192 288c0 99.060 57.502 198.104 128 237.832v52.78c-217.102 17.748-384 124.42-384 253.388h896c0-128.968-166.898-235.64-384-253.388z"></path>
          </svg>
          <span>{props.text}</span>
        </div>
        <div className="profile-bar-unhover11-dashboard">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon02">
        ...
        <div className="profile-bar-unhover11-become-seller">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon04">
        ...
        <div className="profile-bar-unhover11-add-new-freelance">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon06">
        ...
        <div className="profile-bar-unhover11-setting-personal-info">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon08">
        ...
        <div className="profile-bar-unhover11-container3">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon10">
        ...
        <div className="profile-bar-unhover11-container4">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover11-icon12">
          ...
          <span className="profile-bar-unhover11-text6">{props.text12}</span>
        </div>
      </div>
    </div>
  )
...
ProfileBarUnhover11.defaultProps = {
...
export default ProfileBarUnhover11
