...
import './profile-bar-unhover1.css'

const ProfileBarUnhover1 = (props) => {
  return (
    <div className="profile-bar-unhover1-container">
      <div className="profile-bar-unhover1-container1">
        <div className="profile-bar-unhover1-container2">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon">
            <path d="M576 706.612v-52.78c70.498-39.728 128-138.772 128-237.832 0-159.058 0-288-192-288s-192 128.942-192 288c0 99.060 57.502 198.104 128 237.832v52.78c-217.102 17.748-384 124.42-384 253.388h896c0-128.968-166.898-235.64-384-253.388z"></path>
          </svg>
          <span>{props.text}</span>
        </div>
        <div className="profile-bar-unhover1-dashboard">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon02">
        ...
        <div className="profile-bar-unhover1-become-seller">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon04">
        ...
        <div className="profile-bar-unhover1-add-new-freelance">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon06">
        ...
        <div className="profile-bar-unhover1-setting-personal-info">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon08">
        ...
        <div className="profile-bar-unhover1-container3">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon10">
        ...
        <div className="profile-bar-unhover1-container4">
          <svg viewBox="0 0 1024 1024" className="profile-bar-unhover1-icon12">
          ...
          <span className="profile-bar-unhover1-text6">{props.text12}</span>
        </div>
      </div>
    </div>
  )
...
ProfileBarUnhover1.defaultProps = {
  text1112: 'Dashboard',
  text12: 'Log Out',
  text1: 'Night Mode',
  text: 'Profile',
...
export default ProfileBarUnhover1
